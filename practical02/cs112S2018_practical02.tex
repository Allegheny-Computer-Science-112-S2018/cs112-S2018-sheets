...
compute summary statistics for a list of data points, also practicing how to
...
read Chapters 1 through 3 in the textbook, paying particularly close attention
to Sections 1.3 through 1.5 and Section 3.1. Please see the instructor or a
teaching assistant if you have questions on these sections.
...
with a name like
``Allegheny-Computer-Science-112-Spring-2018/computer-science-112-spring-2018-practical-2-gkapfham''.
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-112-S2018/computer-science-112-spring-2018-practical-2-gkapfham.git
\end{lstlisting}
...
errors and get it ready to run. If you see any error messages, go back to your
text editor and figure out what you mis-typed and fix it. Oncer you have solved
...
assistant or the instructor. You can also run the test suite for the
\mainprogram{} by typing \gradletest{} in the terminal. What is the purpose of
each of these test cases? How do they check the output of the methods that
calculate summary statistics? You should keep revising your implementation of
\command{calculateVariance} until all tests pass.
...
sufficient number of times when completing this assignment. If you cannot run
GatorGrader, please talk with the instructor.
...
to determine why, asking a teaching assistant or the course instructor for
