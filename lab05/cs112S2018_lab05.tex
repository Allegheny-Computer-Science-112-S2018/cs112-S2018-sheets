...
\newcommand{\gitcommitmainprogram}{\command{git commit src/main/java/labfive/Experiment.java -m "Your
...
\program{Experiment.sort} method in \program{main}. However, once you ensure
...
\program{Experiment.sort} that follows the outline in Code Fragment 3.6 to
