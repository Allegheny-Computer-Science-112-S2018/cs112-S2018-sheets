...
\begin{lstlisting}
  git clone https://github.com/Allegheny-Computer-Science-112-S2018/computer-science-112-spring-2018-practical-1-gkapfham.git
\end{lstlisting}
...
noticing that one of its methods are incomplete. Specifically, you will notice
