...
\newcommand{\mainprogramsource}{\lstinline{src/test/java/labone/TestCreditCard.java}}
...
src/main/java/labone/CreditCard.java} in your terminal window. This should cause a new window, the \program{gvim}
