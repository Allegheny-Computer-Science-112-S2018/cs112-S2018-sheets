...
\newcommand{\assignmentduedate}{March 6}
...
``Allegheny-Computer-Science-112-Spring-2018/computer-science-112-spring-2018-lab-6-gkapfham''.
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-112-S2018/computer-science-112-spring-2018-lab-6-gkapfham.git
\end{lstlisting}
...
check your project diagram. Your diagram should note what parts of the Java
source code from your previous assignments (e.g., the methods for running an
experiment campaign) can be reused as part of this assignment.
...
some pointers to help you to implement the needed code. 
...
analyze the results that you collect when running an experiment? How can you
apply what you learned in previous assignments to this assignment's experiments?
...
program for errors and get it ready to run. Once the program runs and the tests
pass, please reflect on this process. What step did you find to be the most
...
\mainprogram{}'s implementation, testing, and use.
