...
showing how the classes (both test suites and supporting entities) are related?
For instance, you should notice that the \mainprogramhelper{} has a test suite
called \testprogram{} that is written in the JUnit testing framework; please
refer to Section 1.9 and the comment's in the source code of this test suite to
learn more about how it works. Intuitively, a Junit test suite has individual
test cases, written as Java methods, that each work to establish a confidence in
the correctness of \mainprogram{}.
...
Can you see that it performs the reversal correctly? If not, then repair the
program and re-build and re-run it. Once the program runs, please reflect on
