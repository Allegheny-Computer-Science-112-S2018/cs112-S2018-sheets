...
\newcommand{\mainprogramsource}{\lstinline{src/main/java/labone/SentencesReverser.java}}

% Edit these commands to give the name to the test suite

\newcommand{\testprogram}{\lstinline{TestSentences}}
\newcommand{\testprogramsource}{\lstinline{src/test/java/labone/TestSentences.java}}
...
\newcommand{\gitcommitmainprogram}{\command{git commit src/main/java/labone/SentencesReverser.java -m "Your
...
To continue to learn how to use GitHub to access the files for a assignment. You
will complete a programming project described in the textbook, learning all of
the steps needed to design, implement, and test a sentence-reversing program in
Java. Specifically, you will continue to learn how to implement and test a Java
program and to write a Markdown document, also discovering how to use an
...
Section 1.9 and the comment's in the source code of this test suite to learn more about how it works. Intuitively, a
...
\item Stored in a Markdown file called \reflection{}, a one-paragraph response, each consisting of at least three
  ...
  \begin{enumerate}
    ...
    \item The {\tt SentencesReverser} constructor uses the {\tt this} keyword --- what does it mean?

    \item The {\tt SentencesReverser} class contains a {\tt static} method --- how does it work?

    \item The {\tt SentencesReverser} class has a {\tt main} method --- what is the purpose of this method?

    \item How does the {\tt SentencesReverser} class use a {\tt for} loop and a {\tt while} loop?

    \item The {\tt SentencesReverser} class creates a {\tt wallet} --- what is it and how does it work?
