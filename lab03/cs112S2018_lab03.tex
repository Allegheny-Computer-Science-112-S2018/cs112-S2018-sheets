...
\newcommand{\mainprogramsource}{\lstinline{src/main/java/labtwo/Reverser.java}}
...
\newcommand{\testprogramsource}{\lstinline{src/test/java/labtwo/TestReverser.java}}
...
\newcommand{\gitcommitmainprogram}{\command{git commit src/main/java/labtwo/Reverser.java -m "Your
